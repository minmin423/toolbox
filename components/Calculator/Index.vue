<template>
    <Widget>
        <div class="bg-slate-400/95 p-2 font-semibold text-white w-full">
            <div class="text-end py-8 px-4 border border-slate-500/25 w-full">
            ...
            <div class="grid grid-cols-4 grid-rows-5 text-3xl">
